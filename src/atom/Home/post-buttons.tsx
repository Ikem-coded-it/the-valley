...
const PostLikeButtons = ({ ...props }) => {
  ...
  return (
    <div className="flex flex-col h-[107px] w-[28px] gap-[3px] justify-center -translate-y-4">
      ...
      <p className="font-semibold text-sm text-[#212630] text-center">
        {props.likes}
      </p>
...
const GiveThanksButton = ({ postId }) => {
  ...
  return (
    <PostBottomButton onClick={handleGiveThanks}>Give Thanks</PostBottomButton>
  );
};
