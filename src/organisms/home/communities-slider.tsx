...
export default function CommunitiesSlider() {
    const cards = [
        { imageURL: "/tree.jpg", alt: 'Slide 1', title: 'climate change',members:1200 },
        { imageURL: "/stairs.jpg", alt: 'Slide 2', title: 'Abstract People' ,members:1200},
        { imageURL: "/office.jpg", alt: 'Slide 3', title: 'Standard',members:1200 },
