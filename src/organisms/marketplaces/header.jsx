...
export default function MarketPlacesHeader() {
    return(
        <header className="relative overflow-clip bg-secondary w-full h-[238px] p-6 rounded-[8px] flex flex-col justify-start items-center gap-[48px]">
            <RightPattern/>
            <LeftPattern/>
            <div className="w-full flex flex-col gap-[9px] items-center justify-start">
                <h1 className="font-semibold text-[32px] text-[#FFFFFF] z-10">
                    Marketplaces
                </h1>

                <p className="font-[500] text-sm text-[#FFFFFF] z-10">
